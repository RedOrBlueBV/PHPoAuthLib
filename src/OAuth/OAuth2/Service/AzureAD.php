...
class AzureAD extends AbstractService
{
    ...
    {
        return new Uri('https://login.microsoftonline.com/inos.nl/oauth2/authorize');
    }
    ...
    {
        return new Uri('https://login.microsoftonline.com/inos.nl/oauth2/token');
    }
